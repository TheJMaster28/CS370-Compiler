 ...
 * Lab 7
 * April 9, 2019 
 * C file with functions of the symbol table. Works with the YACC code to have semantic error checking and type checking 
 */  
    
#include <string.h>
#include "symtable.h"

// globel vairable for CreateTemp()
int GTEMP =0;
// creates a temperary vairable for expressions to store result
char * CreateTemp()
{    char hold[100];
     char *s;
...
struct SymbTab * Insert(char *name, enum SYSTEMTYPES Type, int isafunc, int  level, int mysize, int offset , ASTnode * fparms)
